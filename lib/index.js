...
var loger = log.getLogger('jm-pay-mqtt')
...
module.exports = function (opts, app) {
  ...
  pay.on('user.create', function (opts) {
    opts && (publish('pay/user/create', opts))
  })
  pay.on('updateAmount', function (opts) {
    opts && (publish('pay/updateAmount', opts))
  })
  pay.on('transfer', function (opts) {
    opts && (publish('pay/transfer', opts))
  })
}